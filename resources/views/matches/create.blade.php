<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Jadwal Pertandingan</h2>
    </x-slot>

    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('matches.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
                

                    <x-form-errors />

                    @include('matches.partials.form', ['match' => null])
