    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('coaches.update', $coach) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                    @csrf
                    ...
                    @include('coaches.partials.form', ['coach' => $coach])

                    <div class="flex items-center justify-end gap-3">
                        <a href="{{ route('coaches.index') }}" class="text-sm text-gray-600 hover:text-gray-900">Batal</a>
